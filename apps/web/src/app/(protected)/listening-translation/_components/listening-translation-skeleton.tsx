...
export function ListeningTranslationSkeleton() {
  return (
    <div aria-busy="true" aria-label="Loading listening translation catalog" className="space-y-6">
      <span className="sr-only">Loading listening translation catalog…</span>
